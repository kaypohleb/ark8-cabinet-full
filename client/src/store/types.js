...
export const FETCH_USER_HISTORY_DATA_SUCCESS = 'FETCH_USER_HISTORY_DATA_SUCCESS';
export const FETCH_USER_HISTORY_ERROR = 'FETCH_USER_HISTORY_ERROR';
export const FETCH_SETTINGS_LIST_SUCCESS = 'FETCH_SETTINGS_LIST_SUCCESS';
export const FETCH_SETTINGS_LIST_ERROR = 'FETCH_SETTINGS_LIST_ERROR';
export const FETCH_DEFAULT_SETTINGS_SUCCESS = 'FETCH_DEFAULT_SETTINGS_SUCCESS';
export const FETCH_SPEC_SETTINGS_SUCCESS = 'FETCH_SPEC_SETTINGS_SUCCESS';
